...
from classes.Game import GameAccount, GameEnvironment, GamePlatform
...
GB_ENV = GameEnvironment(
    ...
    port=443,
    version_code="5.25.6-4e8c37768d3a1d675e8267c41e84ffc4a781b91139361b76f60f34da91eeae1a",
    db_password=bytearray(
        "eb08f8a58bbdef433e02ac565ae490b0966becf3519dea57a755d440421f5532".encode(
            "utf8"
        )
    ),

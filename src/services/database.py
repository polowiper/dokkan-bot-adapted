...
class DatabaseService:
    ...
    def fetch_latest():
        ...
        if True:  # We do not actually need to have the database to use this bot
        ...
        print(
            Fore.RED
            + Style.BRIGHT
            + "Decrypting latests database... This can take a few minutes..."
        )
        decrypt_file(
            str(temp_db_path),
            config.game_env.db_password,
            str(config.game_env.db_path.absolute()),
        )
